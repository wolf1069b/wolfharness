...
def get_ticket_instructions() -> str:
    ...
    return (
        ...
        "\n"
        "Discovery:\n"
        "- read_resource(uri) — read a wiki entity page; use the content "
        "to prepare candidate_content for full-page changes or "
        "candidate_operations for precise local changes. External-expert OPL "
        "apply does not require expected_sha256.\n"
        ...
        "proposal. Provide either candidate_content (full replacement "
        "markdown for whole-page or broad edits) or candidate_operations "
        "(deterministic local patch ops such as line_replace, "
        "section_replace, fm_set, or move_entity), not both. External-expert "
        "OPL apply is last-writer-wins and does not require "
        "expected_sha256.\n"
